...
código y presentación. Ningún sistema de IA figura como autor.
...
\item
  ...
  segunda edición, Annals of Discrete Mathematics 57, Elsevier,
  Ámsterdam, 2004.
\item
  J. R. S. Blair and B. Peyton, ``An introduction to chordal graphs and
  clique trees,'' en \emph{Graph Theory and Sparse Matrix Computation},
  IMA Volumes in Mathematics and its Applications 56, Springer, Nueva
  York, 1993, pp.~1--29.
\item
  M. S. Cavers, \emph{Clique Partitions and Coverings of Graphs}, ensayo
  M.Math., University of Waterloo, 2005.
\item
  L. de Moura, S. Kong, J. Avigad, F. van Doorn, and J. von Raumer,
  ``The Lean theorem prover (system description),'' en \emph{Automated
  Deduction---CADE-25}, Lecture Notes in Computer Science 9195,
  Springer, 2015, pp.~378--388.
\item
  The Mathlib Community, ``The Lean mathematical library,'' en
...
\item
  ...
  Public Preprints and Formalization Artifacts}, repositorio público del
  proyecto, 2026,

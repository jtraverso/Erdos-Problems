...
- a preprint draft for the split graph case;
- SHA-256 hashes;
- an encrypted timestamped archive of the companion technical drafts for the chordal toolkit, the fractional chordal theorem, and the final rounding step.
